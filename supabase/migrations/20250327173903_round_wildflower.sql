/*
  # Fix user suggestions function parameters

  1. Changes
    - Drop existing function
    - Recreate with exact parameter names matching frontend
    - Add parameter validation
    - Improve error handling with COALESCE
...
BEGIN
  ...
  user_hobbies AS (
    ...
    WHERE uh_user.user_id = p_user_id 
